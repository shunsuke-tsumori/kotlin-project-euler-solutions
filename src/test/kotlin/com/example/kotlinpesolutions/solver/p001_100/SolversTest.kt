...
internal class SolversTest(
    ...
    @Autowired private val p051Solver: P051Solver,
    ...
    @Autowired private val p060Solver: P060Solver,
    @Autowired private val p061Solver: P061Solver,
    @Autowired private val p062Solver: P062Solver,
    @Autowired private val p063Solver: P063Solver,
    @Autowired private val p064Solver: P064Solver,
    @Autowired private val p065Solver: P065Solver,
    @Autowired private val p066Solver: P066Solver,
    @Autowired private val p067Solver: P067Solver,
    @Autowired private val p068Solver: P068Solver,
    @Autowired private val p069Solver: P069Solver,
    @Autowired private val p070Solver: P070Solver,
    @Autowired private val p071Solver: P071Solver,
    @Autowired private val p072Solver: P072Solver,
    @Autowired private val p073Solver: P073Solver,
    @Autowired private val p074Solver: P074Solver,
    @Autowired private val p075Solver: P075Solver,
    @Autowired private val p076Solver: P076Solver,
    @Autowired private val p077Solver: P077Solver,
    @Autowired private val p078Solver: P078Solver,
    @Autowired private val p079Solver: P079Solver,
    @Autowired private val p080Solver: P080Solver,
    @Autowired private val p081Solver: P081Solver,
    @Autowired private val p082Solver: P082Solver,
    @Autowired private val p083Solver: P083Solver,
    @Autowired private val p084Solver: P084Solver,
    @Autowired private val p085Solver: P085Solver,
    @Autowired private val p086Solver: P086Solver,
    @Autowired private val p087Solver: P087Solver,
    @Autowired private val p088Solver: P088Solver,
    @Autowired private val p089Solver: P089Solver,
    @Autowired private val p090Solver: P090Solver,
    @Autowired private val p091Solver: P091Solver,
    @Autowired private val p092Solver: P092Solver,
    @Autowired private val p093Solver: P093Solver,
    @Autowired private val p094Solver: P094Solver,
    @Autowired private val p095Solver: P095Solver,
    @Autowired private val p096Solver: P096Solver,
    @Autowired private val p097Solver: P097Solver,
    @Autowired private val p098Solver: P098Solver,
    @Autowired private val p099Solver: P099Solver,
    @Autowired private val p100Solver: P100Solver,
) {
    ...
    @DisplayName("121313")
    fun p051() {
        assertEquals("121313", p051Solver.run())
    }
    ...
    @DisplayName("26033")
    fun p060() {
        assertEquals("26033", p060Solver.run())
    }

    @Test
    @DisplayName("28684")
    fun p061() {
        assertEquals("28684", p061Solver.run())
    }

    @Test
    @DisplayName("127035954683")
    fun p062() {
        assertEquals("127035954683", p062Solver.run())
    }
    ...
    @DisplayName("1322")
    fun p064() {
        assertEquals("1322", p064Solver.run())
    }

    @Test
    @DisplayName("272")
    fun p065() {
        assertEquals("272", p065Solver.run())
    }

    @Test
    @DisplayName("661")
    fun p066() {
        assertEquals("661", p066Solver.run())
    }
    ...
    @Test
    @DisplayName("6531031914842725")
    fun p068() {
        assertEquals("6531031914842725", p068Solver.run())
    }
    ...
    @DisplayName("8319823")
    fun p070() {
        assertEquals("8319823", p070Solver.run())
    }
    ...
    @Test
    @DisplayName("303963552391")
    fun p072() {
        assertEquals("303963552391", p072Solver.run())
    }
    ...
    @DisplayName("161667")
    fun p075() {
        assertEquals("161667", p075Solver.run())
    }
    ...
    @DisplayName("71")
    fun p077() {
        assertEquals("71", p077Solver.run())
    }
    ...
    @DisplayName("40886")
    fun p080() {
        assertEquals("40886", p080Solver.run())
    }
    ...
    @DisplayName("260324")
    fun p082() {
        assertEquals("260324", p082Solver.run())
    }

    @Test
    @DisplayName("425185")
    fun p083() {
        assertEquals("425185", p083Solver.run())
    }

    @Test
    @DisplayName("101524")
    fun p084() {
        assertEquals("101524", p084Solver.run())
    }

    @Test
    @DisplayName("2772")
    fun p085() {
        assertEquals("2772", p085Solver.run())
    }

    @Test
    @DisplayName("1818")
    fun p086() {
        assertEquals("1818", p086Solver.run())
    }
    ...
    @DisplayName("7587457")
    fun p088() {
        assertEquals("7587457", p088Solver.run())
    }
    ...
    @DisplayName("1217")
    fun p090() {
        assertEquals("1217", p090Solver.run())
    }

    @Test
    @DisplayName("14234")
    fun p091() {
        assertEquals("14234", p091Solver.run())
    }
    ...
    @DisplayName("1258")
    fun p093() {
        assertEquals("1258", p093Solver.run())
    }

    @Test
    @DisplayName("518408346")
    fun p094() {
        assertEquals("518408346", p094Solver.run())
    }

    @Test
    @DisplayName("14316")
    fun p095() {
        assertEquals("14316", p095Solver.run())
    }

    @Test
    @DisplayName("24702")
    fun p096() {
        assertEquals("24702", p096Solver.run())
    }
    ...
    @DisplayName("18769")
    fun p098() {
        assertEquals("18769", p098Solver.run())
    }
    ...
    @Test
    @DisplayName("756872327473")
    fun p100() {
        assertEquals("756872327473", p100Solver.run())
    }
